#!/usr/bin/env sh
# Universal installer for reentryx. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/reentryx.git"
echo "Installing reentryx ..."
